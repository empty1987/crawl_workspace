package com.xmu.core.service.impl;
...
public class BaseServiceImpl implements BaseService {
	 ...
	 * ************************************************************************
	 */
	public Page getPageList(String sqlName4Query, String sqlName4Count,
			Entity entity, Page page) {

		int totalRecord = (Integer) getObject(sqlName4Count, entity);
		page.setTotalCount(totalRecord);
		entity.setStartNo(page.getStartNo());
		entity.setPageSize(page.getPageSize());
		entity.setOrderBy(page.getOrderBy());
		entity.setOrder(page.getOrder());
		List list = getList(sqlName4Query, entity);
		page.setResult(list);
		return page;
	...
	public Page getPageList(String sqlName4Query, String sqlName4Count,
		...
		int totalRecord = (Integer) getObject(sqlName4Count, map);
		page.setTotalCount(totalRecord);
		map.put("startNo", page.getStartNo());
		map.put("pageSize", page.getPageSize());
		map.put("orderBy", page.getOrderBy());
		map.put("order", page.getOrder());
		List list = getList(sqlName4Query, map);
		page.setResult(list);
		return page;
	}
